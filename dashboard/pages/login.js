...
//  console.log('lastFOrmValues',formValues)
 ...
 return (
  ...
  <div className='flex items-center justify-center w-full h-screen bg-slate-700'>
   <div className='flex bg-red-600 w-[700px] h-[500px] rounded-md overflow-hidden shadow-xl shadow-cyan-500'>
    <div className=' flex flex-col h-full w-[50%] bg-slate-800 text-white gap-4 items-center justify-center relative'>
     <span className='font-bold'>Hello, Welcome Login Page !</span>
     <div>
      ...
      <div className="flex flex-col mx-auto w-full gap-2 ">
       <div className="w-full flex  justify-between items-center  gap-2">
        ...
        <input type="text" placeholder="Username"
               ...
               className="h-10 w-[75%] text-black rounded-md border-2 border-cyan-500 shadow shadow-cyan-400 text-center"/>
       </div>
    ...
    <div className=' flex h-full w-[50%] bg-slate-500 items-center'>
