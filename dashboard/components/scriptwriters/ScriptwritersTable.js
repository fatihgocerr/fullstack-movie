...
import ScriptwritersViewContent from "@/components/scriptwriters/modalContent/ViewContent";
import ScriptwritersEditContent from "@/components/scriptwriters/modalContent/EditContent";
import ScriptwritersDeleteContent from "@/components/scriptwriters/modalContent/DeleteContent";
import {getDirectors, getGenres, getStars, getWriters} from "@/services/getVal.service"
import {getAll} from "@/services/scriptwriter.service";
import Scriptwriter from "@/components/scriptwriters/Scriptwriters";
...
const TableIndex = ({refTable}) => {
 ...
 const modalContent = (
  activeContent === 'view'
   ? <ScriptwritersViewContent data={columnData} subData={allData} setModal={setModal}/>
   : activeContent === 'edit'
    ? <ScriptwritersEditContent data={columnData} subData={allData} setModal={setModal}/>
    : <ScriptwritersDeleteContent data={columnData} subData={allData} setModal={setModal}/>
 )
 const columns = [
  {
   title: '#',
