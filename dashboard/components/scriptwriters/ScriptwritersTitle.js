...
import AddContent from '@/components/scriptwriters/modalContent/AddContent';

const Title = ({setRefTable}) => {
 const [modal, setModal] = useState(false);
 const modalContent = (
  <AddContent setModal={setModal} setRefTable={setRefTable} />
 );
 return (
  <>
   <div className="mr-6">
    <h1 className="text-4xl font-semibold mb-2">Scriptwriters</h1>
