...
const ViewMovies = ({data, setModal}) => {
 ...
 const formItem = [
  ...
  {label: 'Vision Date', key: 'visionDate', type: 'text'},
  {label: 'Imdb Score', key: 'imdb', type: 'text'},
  {label: 'Director Id', key: 'directorId', type: 'text'},
  {label: 'Stars', key: 'stars', type: 'text'},
  {label: 'Scriptwriter', key: 'scriptwriter', type: 'text'},
  {label: 'Trailer', key: 'trailer', type: 'text'},
  {label: 'Tags', key: 'tags', type: 'text'},
  {label: 'Summary', key: 'summary', type: 'text'},
  {label: 'Budget', key: 'budget', type: 'text'},
  {label: 'Box Office', key: 'boxOffice', type: 'text'},
  {label: 'Year', key: 'year', type: 'text'},
  {label: 'Awards', key: 'awards', type: 'text'},
  {label: 'Conditions', key: 'conditions', type: 'text'},
  {label: 'Series', key: 'series', type: 'text'},
  {label: 'Country', key: 'country', type: 'text'},
  {label: 'Language', key: 'language', type: 'text'},
  {label: 'Producer', key: 'producer', type: 'text'}
 ]
*/}
 const formItem = [
