...
import DirectorsViewContent from "@/components/directors/modalContent/ViewContent";
import DirectorsEditContent from "@/components/directors/modalContent/EditContent";
import DirectorsDeleteContent from "@/components/directors/modalContent/DeleteContent";
import {getDirectors, getGenres, getStars, getWriters} from "@/services/getVal.service"
import {getAll} from "@/services/directors.service";
...
const TableIndex = ({refTable}) => {
 ...
 const modalContent = (
  activeContent === 'view'
   ? <DirectorsViewContent data={columnData} subData={allData} setModal={setModal}/>
   : activeContent === 'edit'
    ? <DirectorsEditContent data={columnData} subData={allData} setModal={setModal}/>
    : <DirectorsDeleteContent data={columnData} subData={allData} setModal={setModal}/>
 )
