...
import DirectorAddContent from "@/components/directors/modalContent/AddContent";

const Title = ({setRefTable}) => {
 const [modal, setModal] = useState(false);
 const modalContent = (
  <DirectorAddContent setModal={setModal} setRefTable={setRefTable} />
 );
 return (
  <>
   <div className="mr-6">
    <h1 className="text-4xl font-semibold mb-2">Directors</h1>
