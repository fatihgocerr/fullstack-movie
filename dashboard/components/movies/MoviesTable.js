...
import MoviesViewContent from "@/components/movies/moviesModalContent/MoviesViewContent";
import MoviesEditContent from "@/components/movies/moviesModalContent/MoviesEditContent";
import MoviesDeleteContent from "@/components/movies/moviesModalContent/MoviesDeleteContent";
...
const MoviesTable = () => {
 ...
 const modalContent = (
  activeContent === 'view'
   ? <MoviesViewContent data={columnData} subData={allData}  setModal={setModal}/>
   : activeContent === 'edit'
    ? <MoviesEditContent data={columnData} subData={allData}  setModal={setModal}/>
    : <MoviesDeleteContent data={columnData} subData={allData}  setModal={setModal}/>
 )
